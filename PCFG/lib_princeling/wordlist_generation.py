...
# Local Imports
from PCFG.lib_guesser.priority_queue import PcfgQueue


def create_prince_wordlist(socketio,pcfg, max_size):
    """
    ...
    while max_size is None or num_generated_guesses < max_size:
        ...
        # The receiving program is no longer accepting guesses
            ...
            progress = 1
            socketio.emit('progress_update', {'progress': progress * 100})
            break
    socketio.emit('progress_update', {'progress': 100})
